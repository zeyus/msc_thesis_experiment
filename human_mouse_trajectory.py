...
if __name__ == "__main__":
    #trajectory = HumanizeMouseTrajectory([-0.7,-0.5], [0.7,0.5], target_points = 1000, offset_boundary_x = 0.1, offset_boundary_y = 0.1)
    # Steady settings
    import matplotlib.pyplot as plt
    for i in range(5):
        #trajectory = HumanizeMouseTrajectory([10,10], [20,20], target_points = 100, offset_boundary_x = 10, offset_boundary_y = 10, distortion_mean = 1.2, distortion_st_dev = 1.2, distortion_frequency = 1)
        trajectory = HumanizeMouseTrajectory([-350,250], [-500,500], offset_boundary_x = 10, offset_boundary_y = 10, distortion_mean = 1.2, distortion_st_dev = 1.2, distortion_frequency = 1)
        plt.plot(np.array(trajectory.points)[:, 0]/1000,np.array(trajectory.points)[:, 1]/1000,"o")
"""